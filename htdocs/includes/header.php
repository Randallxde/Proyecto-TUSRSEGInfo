...
<head>
    ...
    <style>
        /* Corrección definitiva del espacio superior debido al menú fijo */
        body {
            padding-top: 56px !important; /* Ajuste exacto a la altura estándar de la navbar de Bootstrap */
...
<?php if ($flash): ?>
    <div class="container pt-3">
        <div class="alert alert-<?= e($flash['tipo']) ?> shadow-sm mb-0">
            <?= e($flash['mensaje']) ?>
        </div>
    </div>
<?php endif; ?>